...
When distributing the DMG, make sure you:
- Include the `LICENSE` file in the DMG or app bundle
- Provide a source code link in your release notes or download page
...
- [ ] Source code link provided (AGPLv3 distribution requirement)
